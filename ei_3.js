...
function newton(funcao, primDerivada, segDerivada, intervaloA, intervaloB, tolerancia, maxIteracoes) {
  let table = new AsciiTable('Método de Newton');
...
newton('x^2-3', '2x', '2', 1, 2, 0.01, 100);
newton('x^2 + log(x)', '2x+(1/x)', '2-(1/x^2)', 0.5, 1, 0.01, 100);
newton('4cos(x)-e^x', '-4sin(x)-e^x', '-4cos(x)-e^x', 0, 1, 0.01, 100);